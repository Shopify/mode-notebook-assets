...
# read test series
import mode_notebook_assets.practical_dashboard_displays.metric_evaluation_pipeline.legacy_metric_evaluation_pipeline
...
def test_disable_steady_state():
    assert mode_notebook_assets.practical_dashboard_displays.metric_evaluation_pipeline.legacy_metric_evaluation_pipeline.LegacyMetricEvaluationPipeline(
        _ts,
