...
grid_display = dg.GridDisplay(
    ...
    column_schema=[
        dg.PlotlyTraceGridColumnSpec(horizontal_units=1),
        dg.PlotlyTraceGridColumnSpec(horizontal_units=2),
        dg.PlotlyTraceGridColumnSpec(horizontal_units=1),
        dg.PlotlyTraceGridColumnSpec(horizontal_units=4),
    ],
...
with streamlit.beta_expander(label='JSON'):
    streamlit.code(
        body=json.dumps(grid_display.to_plotly_figure().to_plotly_json(), indent=4, sort_keys=True),
        language='json'
    )
...
trace5 = {
    ...
    "xaxis": "x3",
    "yaxis": "y3",
    "marker": {"color": ["rgb(0,210,0)", "rgb(0,210,0)", "rgb(0,210,0)", "rgb(0,210,0)", "rgb(0,210,0)", "rgb(0,210,0)", "rgb(0,210,0)", "rgb(0,210,0)", "rgb(0,210,0)", "rgb(0,0,255)"]}
}
trace6 = {
    "type": "bar",
    "x": [0],
